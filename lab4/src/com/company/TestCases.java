...
public class TestCases
{
   ...
   public void testTranslatePolygon()
           throws NoSuchMethodException
   {
      Point[] points = {new Point(1,2), new Point(3,2), new Point(3,4)};
      ConvexPolygon c = new ConvexPolygon(points, Color.BLACK);

      c.translate(new Point(0,0));

      assertEquals(new Point(0,0), c.getVertex(0));
      assertEquals(new Point(0,0), c.getVertex(1));
      assertEquals(new Point(0,0), c.getVertex(2));
