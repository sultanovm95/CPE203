...
import com.company.NegativeRadiusException;
import com.company.ZeroRadiusException;
...
{   
   ...
   public void zeroRadiusExceptionArchitectureTest()
   {
      ...
      assertEquals("Parent of ZeroRadiusException should be CircleException.",
                   "com.company.CircleException", c.getSuperclass().getName());
   }
   ...
   @Test
   public void throwsNothing() throws NegativeRadiusException, ZeroRadiusException {
      Circle c = new Circle(3);
   }
   
   @Test(expected = ZeroRadiusException.class)
   public void throwsZeroRadiusException() throws NegativeRadiusException, ZeroRadiusException {
