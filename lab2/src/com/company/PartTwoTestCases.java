...
public class PartTwoTestCases
{
   ...
   public void testPerimRect() {
      Point cord1 = new Point(0,2);
      Point cord2 = new Point(2, -2);
      Rectangle rectangle = new Rectangle(cord1,cord2);
      double d = rectangle.perimeter();
      assertEquals(12.0, d, DELTA);
   }
   ...
   public void testPerimCircle() {
      Point cord1 = new Point(0,2);
      double radius = 2.0;
      Circle circle = new Circle(cord1, radius);
   ...
   public void testWhichIsBigger() {
      ...
      Point cord1 = new Point(0,2);
      Point cord2 = new Point(4, -2);
      Rectangle rectangle = new Rectangle(cord1,cord2);
      // Biggest Perim = 16.0  P = (4+4)*2

      Point cord3 = new Point(0,2);
      double radius = 2.0;
      Circle circle = new Circle(cord1, radius);

      double whichIsBigger = Bigger.whichIsBigger(circle,rectangle,polygon);
      assertEquals(16.0, whichIsBigger, DELTA);
